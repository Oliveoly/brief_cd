...
from app_api.modules.crud import read_db, write_db, initialize_db
...
@app.post("/data/", response_model= QuoteResponse)
...
@app.get("/data/", response_model=List[QuoteResponse])
def read_all_quotes():
    df = read_db()
